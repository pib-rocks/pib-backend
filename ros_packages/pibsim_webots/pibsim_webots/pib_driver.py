...
class PibDriver:
    def init(self, webots_node, properties):
        ...
        self.__devices['shoulder_horizontal_left'] = [self.__robot.getDevice('shoulder_horizontal_left'),]
        self.__devices['shoulder_vertical_right'] = [self.__robot.getDevice('shoulder_vertical_right'),]
        self.__devices['shoulder_vertical_left'] = [self.__robot.getDevice('shoulder_vertical_left'),]
        self.__devices['elbow_right'] = [self.__robot.getDevice('elbow_right'),]
        self.__devices['elbow_left'] = [self.__robot.getDevice('elbow_left'),]
