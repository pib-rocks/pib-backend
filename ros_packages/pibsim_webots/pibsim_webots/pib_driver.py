...
class PibDriver:
    def init(self, webots_node, properties):
        ...
        self.__devices["turn_head_motor"] = [
            self.__robot.getDevice("head_horizontal"),
        ]
        self.__devices["tilt_forward_motor"] = [
            self.__robot.getDevice("head_vertical"),
        ]
        self.__devices["shoulder_horizontal_right"] = [
            self.__robot.getDevice("shoulder_horizontal_right"),
        ]
        self.__devices["shoulder_horizontal_left"] = [
            self.__robot.getDevice("shoulder_horizontal_left"),
        ]
        self.__devices["shoulder_vertical_right"] = [
            self.__robot.getDevice("shoulder_vertical_right"),
        ]
        self.__devices["shoulder_vertical_left"] = [
            self.__robot.getDevice("shoulder_vertical_left"),
        ]
        self.__devices["elbow_right"] = [
            self.__robot.getDevice("elbow_right"),
        ]
        self.__devices["elbow_left"] = [
            self.__robot.getDevice("elbow_left"),
        ]

        self.__devices["lower_arm_right_rotation"] = [
            self.__robot.getDevice("forearm_right"),
        ]
        self.__devices["lower_arm_left_rotation"] = [
            self.__robot.getDevice("forearm_left"),
        ]
        self.__devices["thumb_left_stretch"] = [
            self.__robot.getDevice("thumb_left_distal"),
            self.__robot.getDevice("thumb_left_proximal"),
        ]
        self.__devices["thumb_right_stretch"] = [
            self.__robot.getDevice("thumb_right_distal"),
            self.__robot.getDevice("thumb_right_proximal"),
        ]
        self.__devices["index_right_stretch"] = [
            self.__robot.getDevice("index_right_distal"),
            self.__robot.getDevice("index_right_proximal"),
        ]
        self.__devices["middle_right_stretch"] = [
            self.__robot.getDevice("middle_right_distal"),
            self.__robot.getDevice("middle_right_proximal"),
        ]
        self.__devices["ring_right_stretch"] = [
            self.__robot.getDevice("ring_right_distal"),
            self.__robot.getDevice("ring_right_proximal"),
        ]
        self.__devices["pinky_right_stretch"] = [
            self.__robot.getDevice("pinky_right_distal"),
            self.__robot.getDevice("pinky_right_proximal"),
        ]
        self.__devices["index_left_stretch"] = [
            self.__robot.getDevice("index_left_distal"),
            self.__robot.getDevice("index_left_proximal"),
        ]
        self.__devices["middle_left_stretch"] = [
            self.__robot.getDevice("middle_left_distal"),
            self.__robot.getDevice("middle_left_proximal"),
        ]
        self.__devices["ring_left_stretch"] = [
            self.__robot.getDevice("ring_left_distal"),
            self.__robot.getDevice("ring_left_proximal"),
        ]
        self.__devices["pinky_left_stretch"] = [
            self.__robot.getDevice("pinky_left_distal"),
            self.__robot.getDevice("pinky_left_proximal"),
        ]

        self.__devices["all_fingers_right"] = []
        self.__devices["all_fingers_right"].extend(
            self.__devices["thumb_right_stretch"]
        )
        self.__devices["all_fingers_right"].extend(
            self.__devices["index_right_stretch"]
    ...
    def __trajectory_callback(self, trajectory):
        ...
        self.__node.get_logger().info(
            ...
            + "  "
            + str(trajectory.points[0].positions[0])
        )
    ...
    def set_target_positions(self):
        for index in range(len(self.__target_trajectory.joint_names)):
            ...
            position = self.convert_cerebra(
                self.__target_trajectory.points[0].positions[index]
            )
