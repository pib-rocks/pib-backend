...
class BrickletPin:
    ...
    def apply_settings(self, settings_dto: dict[str, Any]) -> bool:
        ...
        try:
            ...
            self.bricklet.set_degree(
                self.pin,
                settings_dto["rotationRangeMin"],
                settings_dto["rotationRangeMax"],
            )
    ...
    def get_settings(self) -> dict[str, Any]:
        ...
        try:
            ...
            settings_dto["rotationRangeMin"], settings_dto["rotationRangeMax"] = (
                self.bricklet.get_degree(self.pin)
            )
