                ...
                try:
                        ...
                        for motor in motors: 
                                ...
                                if applied or self.dev: 
                                        persisted, _ = motor_client.update_motor_settings(motor.name, motor_settings_dto)
                        ...
                        response = MotorSettingsSrv.Response(settings_applied=False, settings_persisted=False)
                        self.get_logger().warn(f"Error while processing motor-settings-message: {str(e)}")
