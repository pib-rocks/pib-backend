...
def _create_chat_data_and_assistant() -> None:
    ...
    p_eva = Personality(
        ...
        gender="Female",
        pause_threshold=0.8,
        assistant_model_id=claude_text.id,
    )
