...
from schema.assistant_model_schema import (
    assistant_models_schema,
    assistant_model_schema,
)
...
def get_assistant_model(assistant_model_id):
    assistant_models = assistant_model_service.get_assistant_model_by_id(
        assistant_model_id
    )
    return assistant_model_schema.dump(assistant_models)
