...
public class SuccessfulVoiceAssistantPersonalityCreationResponse   {
  ...
  public SuccessfulVoiceAssistantPersonalityCreationResponse personalityId(String personalityId) {
  ...
  public SuccessfulVoiceAssistantPersonalityCreationResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SuccessfulVoiceAssistantPersonalityCreationResponse description(String description) {
  ...
  public SuccessfulVoiceAssistantPersonalityCreationResponse gender(GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  public SuccessfulVoiceAssistantPersonalityCreationResponse pauseThreshold(BigDecimal pauseThreshold) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.personalityId, successfulVoiceAssistantPersonalityCreationResponse.personalityId) &&
        Objects.equals(this.name, successfulVoiceAssistantPersonalityCreationResponse.name) &&
        Objects.equals(this.description, successfulVoiceAssistantPersonalityCreationResponse.description) &&
        Objects.equals(this.gender, successfulVoiceAssistantPersonalityCreationResponse.gender) &&
        Objects.equals(this.pauseThreshold, successfulVoiceAssistantPersonalityCreationResponse.pauseThreshold);
  }
